...
[![Portfolio](https://img.shields.io/badge/Portfolio-FF5722?style=for-the-badge&logo=google-chrome&logoColor=white&labelColor=FF5722)](https://vedanshrathi.vercel.app)
...
```mermaid
graph LR
    A[🏠 Ship PropIntel] --> B[🚀 Production-Ready AI Systems]
    C[🔷 Master Kafka] --> D[📡 Real-time Data Pipelines]
    E[🏗️ System Design] --> F[⚙️ Scalable Architectures]
    G[💼 Professional Growth] --> H[🎓 Continuous Learning]
```
